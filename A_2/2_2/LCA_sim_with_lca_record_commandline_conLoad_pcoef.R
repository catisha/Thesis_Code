...
print(cor(cbind(posterior.gmm,posterior.lca.F, posterior.lca.T.CL,posterior.lca.T.NCL)))
cor(cbind(posterior.gmm,posterior.lca.F, posterior.lca.T.CL,posterior.lca.T.NCL))
...
correlation[i,]=(cor(cbind(posterior.gmm,posterior.lca.F,posterior.lca.T.CL, posterior.lca.T.NCL)))

}
correlation
save(correlation, file=paste0(out, "/3models_correlation_5_samples_151218_lca_sim_p_",p,"_delta_", delta, "_sigma.z_", sigma.z, "_p.0_", p.0))
save(lca.T.CL_record, file=paste0(out, "/3models_lca.T.CL_record_5_samples_151218_lca_sim_p_",p,"_delta_", delta, "_sigma.z_", sigma.z, "_p.0_", p.0))
save(lca.T.NCL_record, file=paste0(out, "/3models_lca.T.NCL_record_5_samples_151218_lca_sim_p_",p,"_delta_", delta, "_sigma.z_", sigma.z, "_p.0_", p.0))
save(lca.F_record, file=paste0(out, "/3models_lca.F_record_5_samples_151218_lca_sim_p_",p,"_delta_", delta, "_sigma.z_", sigma.z, "_p.0_", p.0))
save(b_record,p, delta, sigma.z, p.0, file=paste0(out, "/3models_b_record_parameter_list_5_samples_151218_lca_sim_p_",p,"_delta_", delta, "_sigma.z_", sigma.z, "_p.0_", p.0))

print(correlation)
save(out, lca.fit.T.CL,lca.fit.T.NCL, lca.fit.F,  x.sort, y.sort, threshold, gmm.fit, posterior.lca.F, posterior.lca.T.CL, posterior.lca.T.NCL, posterior.gmm,file=paste0(out, "3models_results_151218_lca_sim_p_",p,"_delta_", delta, "_sigma.z_", sigma.z, "_p.0_", p.0) )
