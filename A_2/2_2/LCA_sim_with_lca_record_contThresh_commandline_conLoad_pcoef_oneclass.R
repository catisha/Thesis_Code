...
lca.fit.T.NCL =tryCatch({
  randomLCA(y,random=T,probit=T, nclass=1, quadpoints=190, qniterations=5, constload = F)
}, error=function(e){
...
save(lca.T.CL_record, file=paste0(out, "/3models_oneclass_181218_contThresh_lca.T.CL_record_5_samples_lca_sim_p_",p,"_delta_", delta, "_sigma.z_", sigma.z, "_p.0_", p.0))
save(lca.T.NCL_record, file=paste0(out, "/3models_oneclass_181218_contThresh_lca.T.NCL_record_5_samples_lca_sim_p_",p,"_delta_", delta, "_sigma.z_", sigma.z, "_p.0_", p.0))
save(lca.F_record, file=paste0(out, "/3models_oneclass_181218_contThresh_lca.F_record_5_samples_lca_sim_p_",p,"_delta_", delta, "_sigma.z_", sigma.z, "_p.0_", p.0))
save(b_record,p, delta, sigma.z, p.0, file=paste0(out, "/3models_oneclass_181218_contThresh_b_record_parameter_list_5_samples_lca_sim_p_",p,"_delta_", delta, "_sigma.z_", sigma.z, "_p.0_", p.0))

#print(correlation)
save(out, lca.fit.T.CL,lca.fit.T.NCL, lca.fit.F,  x.sort, y.sort, threshold, posterior.lca.F, posterior.lca.T.CL, posterior.lca.T.NCL,file=paste0(out, "3models_oneclass_181218_contThresh_results_lca_sim_p_",p,"_delta_", delta, "_sigma.z_", sigma.z, "_p.0_", p.0) )
